...
Si va a compilar todo para ir probandolo le recomiendo tener los .txt en la misma carpeta que el .exe, de otra forma tendra que cambiar el campo correspondiente al nombre de los archivos en objetos.c a la carpeta donde los guarde.
